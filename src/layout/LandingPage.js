  ...
  return (
    <div className="landing-page">
      ...
      <div className="rectangle-container">
        ...
        <img className="group-child4" alt="" src="/ellipse-3.svg" />
        <img className="group-child5" alt="" src="/ellipse-4.svg" />
        <img className="group-child6" alt="" src="/ellipse-5.svg" />
        ...
        <img className="job-seeker-icon" alt="" src="/job-seeker@2x.png" />
        <img
      ...
      <img className="landing-page-child4" alt="" src="/ellipse-6.svg" />
      ...
      <img className="landing-page-child11" alt="" src="/ellipse-18@2x.png" />
      ...
      <img className="frame-icon7" alt="" src="/frame6.svg" />
      <div className="hrsweek1">45 hrs/week</div>
      <button className="rectangle-parent5">
        <div className="group-child16" />
        <div className="apply-now">Apply Now</div>
      </button>
      <img className="landing-page-child15" alt="" src="/ellipse-19@2x.png" />
      ...
      <img className="frame-icon8" alt="" src="/frame6.svg" />
      <div className="hrsweek2">35 hrs/week</div>
      <button className="rectangle-parent6">
        <div className="group-child16" />
        <div className="apply-now">Apply Now</div>
      </button>
      <img className="landing-page-child19" alt="" src="/ellipse-20@2x.png" />
      ...
      <img className="frame-icon9" alt="" src="/frame6.svg" />
      <div className="hrsweek3">32 hrs/week</div>
      <button className="rectangle-parent7">
        <div className="group-child16" />
        <div className="apply-now">Apply Now</div>
      </button>
      <img className="landing-page-child23" alt="" src="/ellipse-21@2x.png" />
      ...
      <img className="frame-icon10" alt="" src="/frame6.svg" />
      <div className="hrsweek4">48 hrs/week</div>
      <button className="rectangle-parent8">
        <div className="group-child16" />
        <div className="apply-now">Apply Now</div>
      </button>
      <img className="landing-page-child27" alt="" src="/ellipse-22@2x.png" />
      ...
      <img className="frame-icon11" alt="" src="/frame6.svg" />
      <div className="hrsweek5">25 hrs/week</div>
      <button className="rectangle-parent9">
        <div className="group-child16" />
        <div className="apply-now">Apply Now</div>
      </button>
      <img className="landing-page-child31" alt="" src="/ellipse-23@2x.png" />
      <div className="landing-page-child32" />
      <div className="full-time5">Full-Time</div>
      <div className="landing-page-child33" />
      <img className="landing-page-child34" alt="" src="/ellipse-11.svg" />
      <img className="landing-page-child35" alt="" src="/ellipse-11.svg" />
      <img className="landing-page-child36" alt="" src="/ellipse-12.svg" />
      ...
      <button className="landing-page-inner1">
        <img className="group-child24" alt="" src="/ellipse-14.svg" />
      </button>
      ...
      <button className="ellipse-parent">
        <img className="group-child24" alt="" src="/ellipse-14.svg" />
        <img className="frame-icon12" alt="" src="/frame7.svg" />
      </button>
      <img className="frame-icon13" alt="" src="/frame8.svg" />
      <img className="frame-icon14" alt="" src="/frame9.svg" />
      <button className="ellipse-group">
        <img className="group-child24" alt="" src="/ellipse-14.svg" />
        <img className="frame-icon12" alt="" src="/frame10.svg" />
      </button>
      <div className="landing-page-child38" />
      <img className="frame-icon16" alt="" src="/frame11.svg" />
